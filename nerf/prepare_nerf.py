...
image_dir = "images"  # folder containing captured frames. contains RGB frames used for NeRF
image_files = sorted(os.listdir(image_dir)) # ensures images align exactly with pose order 
